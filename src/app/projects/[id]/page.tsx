                ...
                <div className="flex flex-col gap-8">
                  <div className="p-8 rounded-3xl border border-white/5 bg-white/[0.02] flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                      <span className="text-red-500 font-bold uppercase tracking-[0.2em] text-xs">Architecture Type</span>
                      <p className="text-white text-xl font-bold">{project.system_architecture.type}</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                      {project.system_architecture.components.map((comp, idx) => (
                        <div key={idx} className="p-4 rounded-xl bg-white/5 border border-white/10">
                          <p className="text-slate-300 text-sm font-medium">{comp}</p>
                        </div>
                      ))}
                    </div>
                    <div className="mt-6 pt-6 border-t border-white/5">
                      <span className="text-red-500 font-bold uppercase tracking-[0.2em] text-xs">System Flow</span>
              ...
              <section className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="relative aspect-video rounded-2xl overflow-hidden border border-white/10 group">
                    ...
                    />
                    <div className="absolute bottom-4 left-4 right-4 p-3 bg-black/60 backdrop-blur-md rounded-xl border border-white/10">
                      <p className="text-white text-xs font-bold uppercase tracking-widest text-center">Multimodal Analysis</p>
                    </div>
                  </div>
                  <div className="relative aspect-video rounded-2xl overflow-hidden border border-white/10 group">
                    <Image
                    ...
                    />
                    <div className="absolute bottom-4 left-4 right-4 p-3 bg-black/60 backdrop-blur-md rounded-xl border border-white/10">
                      <p className="text-white text-xs font-bold uppercase tracking-widest text-center">Automated Q&A Pairing</p>
                    </div>
                  </div>
                </div>
              </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {(project.pipeline || []).map((stage, index) => (
                    <div key={index} className="relative p-6 rounded-2xl border border-white/5 bg-white/[0.02] hover:border-red-500/30 transition-all group overflow-hidden">
                      ...
                      <h4 className="text-red-500 font-bold uppercase tracking-widest text-[10px] mb-2">Stage {index + 1}</h4>
                      <p className="text-white font-bold relative z-10">{stage}</p>
                    </div>
                  ))}
                </div>
              </section>
