      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center px-4 md:px-8 relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="order-2 lg:order-1 flex flex-col items-start gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="hero-heading text-base md:text-xl text-slate-400 max-w-xl leading-relaxed font-medium break-words">
              I'm{" "}
              <span className="text-white font-bold">{personalData.name}</span>,
              a professional
              <span
                className="text-red-500 ml-2 font-bold inline-block md:min-w-[280px]"
                ref={designationRef}
              >
                ...
                <code className="font-mono text-xs md:text-sm lg:text-base leading-relaxed block">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-red-300">'Abrarali Sunasara'</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      <span className="text-slate-200">productionReady:</span>{" "}
