        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8 order-2 lg:order-1">
            ...
            <div className="relative group p-8 lg:p-10 rounded-3xl border border-white/5 bg-white/[0.02] backdrop-blur-3xl overflow-hidden shadow-2xl">
              ...
              <div className="about-description text-slate-300 text-base md:text-lg lg:text-xl leading-relaxed text-left md:text-justify space-y-4 font-medium italic break-words">
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-x-8 gap-y-6 items-center mt-4">
              <div className="flex flex-col">
                <span className="text-2xl md:text-3xl font-black text-white">2+</span>
                <span className="text-[10px] md:text-xs text-slate-500 uppercase tracking-widest font-bold">
                  Years Experience
                </span>
              </div>
              ...
              <div className="hidden sm:block w-[1px] h-10 bg-white/10" />
              <div className="flex flex-col">
                <span className="text-2xl md:text-3xl font-black text-white">5+</span>
                <span className="text-[10px] md:text-xs text-slate-500 uppercase tracking-widest font-bold">
                  Tech Domains
                </span>
              </div>
